...
export default function Cadastrar() {
	...
	const { mutate, isPending } = useMutation<FormData, Awaited<ReturnType<typeof postVolunteer>>>(
	...
	return (
		<div className="max-w-lg mx-auto p-6">
			<div className="flex items-center mb-6">
				...
				<h1 className="text-sm md:text-2xl font-semibold ml-2">Cadastrar Voluntário</h1>
			</div>
