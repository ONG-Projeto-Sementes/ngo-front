...
export function DonationCategoryCard({ category, onEdit, onToggleActive }: DonationCategoryCardProps) {
  return (
    <Card
      className={`hover:shadow-lg transition-all duration-300 ${!category.isActive ? 'opacity-70 border-dashed border-gray-300' : 'border-solid hover:border-gray-300'}`}
    >
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <CardTitle className="text-xl font-semibold text-gray-900 truncate">{category.name}</CardTitle>
